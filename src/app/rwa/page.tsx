      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          >
            ...
            <h1 className="font-headline text-5xl md:text-6xl text-white leading-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            <motion.div
              ...
              className="relative group aspect-[16/9] bg-surface-container-low overflow-hidden border border-outline-variant/10"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 bg-surface-container-high border border-outline-variant/10">
                <h3 className="font-headline text-xl text-white mb-6">
              ...
              <div className="p-8 bg-surface-container-highest border border-outline-variant/15 flex flex-col justify-center items-center text-center">
                <Flame className="text-primary mb-4" size={48} fill="currentColor" />
                <h3 className="font-headline text-2xl text-white mb-2">
                  Burn to Redeem
                </h3>
                <p className="font-body text-sm text-white/60 mb-6 px-4">
              ...
              <div className="p-6 space-y-8">
                <div className="space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-label text-[10px] text-secondary uppercase tracking-widest bg-secondary/10 px-2 py-1">
                      In Transit
                    </span>
                  </div>
