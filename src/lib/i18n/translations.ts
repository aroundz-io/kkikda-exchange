...
export const translations = {
  ...
  "rwa.disconnectedBody": {
    en: "Submit a redemption request for your Vintage Pu'er NFT and collect the physical cake at a designated trade point. Vault staff handle every on-chain step (transfer suspension, verification, post-pickup burn) — you simply submit the request and visit with a valid ID.",
    ko: "보유하신 골동보이차 NFT의 인수 신청을 제출하시면 지정 거래지점에서 실물 차를 수령하실 수 있습니다. 모든 온체인 절차(거래 정지, 검증, 수령 후 소각)는 보관소 직원이 직접 시행하며, 사용자는 신청 제출과 신분증 지참 방문만 하시면 됩니다.",
  },
  "rwa.connectToStart": {
  ...
  "rwa.howStep3": { en: "Admin freezes & stages", ko: "관리자 거래정지 및 준비" },
  "rwa.howStep3Desc": {
    en: "Vault staff suspend the NFT's transferability and stage the matching physical cake at your selected trade point.",
    ko: "관리자가 NFT의 거래를 정지시키고, 선택하신 거래지점에 실물 차를 준비합니다.",
  },
  "rwa.howStep4": { en: "Visit & receive", ko: "방문 및 수령" },
  "rwa.howStep4Desc": {
    en: "Bring your ID. After handover, the admin burns the NFT on-chain to finalize the redemption.",
    ko: "신분증을 지참하여 방문 후 수령하시면, 관리자가 온체인에서 NFT를 소각하여 인수가 최종 확정됩니다.",
  },
  "rwa.tradePoints": { en: "Trade Points", ko: "거래지점" },
  "rwa.tradePointsDesc": {
    en: "Two vault-grade locations. Pick whichever is closest at request time.",
    ko: "보관소급 2개 지점. 신청 시 가장 가까운 곳을 선택하세요.",
  },
  ...
  "rwa.modalTitle": { en: "Redemption Request", ko: "인수 신청" },
  ...
  "rwa.confirmRedemption": { en: "Submit Request", ko: "신청 제출" },
  "rwa.modalNotice": {
    en: "No wallet signature required. Vault staff handle the on-chain freeze and post-pickup burn.",
    ko: "지갑 서명이 필요하지 않습니다. 거래 정지와 수령 후 소각은 보관소 직원이 직접 처리합니다.",
  },
  ...
  // Status labels (5-step user-visible flow)
  "rwa.status.submitted": { en: "Submitted", ko: "신청 접수" },
  "rwa.status.frozen": { en: "Trade Suspended", ko: "거래 정지" },
  "rwa.status.ready_for_pickup": { en: "Ready for Pickup", ko: "인수 준비 완료" },
  "rwa.status.picked_up": { en: "Picked Up", ko: "수령 완료" },
  "rwa.status.burned": { en: "NFT Burned", ko: "NFT 소각 완료" },
  "rwa.status.cancelled": { en: "Cancelled", ko: "취소됨" },
  "rwa.statusStep1": { en: "Request submitted", ko: "신청 접수" },
  "rwa.statusStep2": { en: "Trade suspended", ko: "거래 정지" },
  "rwa.statusStep3": { en: "Staged at trade point", ko: "거래지점 준비" },
  "rwa.statusStep4": { en: "Picked up in person", ko: "직접 수령" },
  "rwa.statusStep5": { en: "NFT burned", ko: "NFT 소각" },
  "rwa.viewFreezeTx": { en: "View Freeze Tx", ko: "거래정지 트랜잭션" },
  "rwa.viewBurnTx": { en: "View Burn Tx", ko: "소각 트랜잭션" },
